            ...
            {weekDays.map((day, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div 
                    className="grid h-7 bg-muted/5 border-t border-border/30"
              ...
              return (
                ...
                >
                  ...
                  {HOURS.map((h) => (
                    <div
                      key={h}
                      className="absolute w-full border-b border-border/40 grid"
                      style={{ 
                    ...
                    return (
                      <button
                        ...
                        style={{ 
                          top: `${topPct}%`, 
                          height: `${heightPct}%`, 
                          left: `calc((100% / ${courtCount}) * ${actualIndex})`, 
                          width: `calc((100% / ${courtCount}) - 2px)`,
                          minHeight: "24px",
                          marginLeft: "1px"
                        }}
                      >
